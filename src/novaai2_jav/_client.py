...
from ._exceptions import APIStatusError, Novaai2JavError
...
class Novaai2Jav(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Novaai2Jav client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("NOVAAI2_JAV_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> Novaai2JavWithRawResponse:
        return Novaai2JavWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> Novaai2JavWithStreamedResponse:
        return Novaai2JavWithStreamedResponse(self)
...
class AsyncNovaai2Jav(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncNovaai2Jav client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncNovaai2JavWithRawResponse:
        return AsyncNovaai2JavWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncNovaai2JavWithStreamedResponse:
        return AsyncNovaai2JavWithStreamedResponse(self)
...
class Novaai2JavWithRawResponse:
    _client: Novaai2Jav

    def __init__(self, client: Novaai2Jav) -> None:
        self._client = client
...
class AsyncNovaai2JavWithRawResponse:
    _client: AsyncNovaai2Jav

    def __init__(self, client: AsyncNovaai2Jav) -> None:
        self._client = client
...
class Novaai2JavWithStreamedResponse:
    _client: Novaai2Jav
...
class AsyncNovaai2JavWithStreamedResponse:
    _client: AsyncNovaai2Jav
