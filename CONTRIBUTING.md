...
modify the contents of the `src/novaai2_jav/lib/` and `examples/` directories.
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/irrigationsolutions2391-pixel/landscapeforgeai-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
